...
extension DSL.Model.Style {
    ...
    struct TextField: Decodable, BaseStyleProtocol, StylePointerResolvable, MergeableStyle {
        ...
        /// Content padding. Defaults: top=0, left=12, bottom=0, right=12.
        ...
        func merging(withBase base: Any) -> TextField? {
            guard var base = base as? TextField else { return nil }
